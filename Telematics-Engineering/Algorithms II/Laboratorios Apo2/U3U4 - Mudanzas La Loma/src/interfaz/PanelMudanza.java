...
public class PanelMudanza extends JPanel implements ActionListener {
	...
	private JButton btnRegistrar, btnCargar, btnConsultar, btnRealizar;
	...
	public PanelMudanza(Ventana ventana) {
		...
		// Fin Panel inferior
		// iljojoa
		inhabilitarComponentes(btnLimpiar);
	}
	public void inhabilitarComponentes(JButton lim){
		this.btnConsultar.setEnabled(false);
		this.cmbConsecutivos.setEnabled(false);
		this.cmbClientes.setEnabled(false);
		this.txtDireccionSalida.setEnabled(false);
		this.txtDireccionLlegada.setEnabled(false);
