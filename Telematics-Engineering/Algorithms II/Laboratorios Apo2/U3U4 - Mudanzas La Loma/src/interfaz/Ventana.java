...
public class Ventana extends JFrame {
	...
	public String cargarArticulo(String descripcion, String peso,
		...
		try {
			...
			//iljojoa
			//respuesta = this.mudanzaLaLoma.cargarArticulo(this.consecutivoMudanzaActual, descripcion, pesoKilogramos,esFragil);
		} catch (Exception error) {
			JOptionPane.showMessageDialog(this,
	...
	public void actualizarMudanza() {
		try {
			//iljojoa
			Mudanza mudanza = null;
			//Mudanza mudanza = this.mudanzaLaLoma.buscarMudanza(this.consecutivoMudanzaActual);
			if (mudanza != null) {
