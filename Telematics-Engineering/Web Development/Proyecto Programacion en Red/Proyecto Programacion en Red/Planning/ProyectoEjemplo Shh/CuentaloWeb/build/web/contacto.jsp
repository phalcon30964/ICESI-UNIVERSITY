<%-- 
    Document   : contacto
    Created on : 31-oct-2013, 20:44:42
    Author     : Jesmol
--%>
            ...
            <div id="mid_content">
                <div class="container">
                    <div class="mid_content_info mid_content_space">
                        <iframe src="https://docs.google.com/forms/d/1DxCQN7qFxX3iUuaPUUmR0_Qhhtahyl6KEiVSyQM-c7Q/viewform?embedded=true" 
                                width="1000" height="400" frameborder="0" marginheight="0" marginwidth="0">Cargando...
                        </iframe>
                    </div>
                </div> <!-- END .container -->
            </div> <!-- END #mid_content -->
