            ...
            <div id="mid_content">
                <div class="container">
                    <div class="mid_content_info mid_content_space">
                        ...
                        <DIV ALIGN=center>
                            <%
                                ...
                                String elCuento = "";
                                if (request.getParameter("campoCuentos") != null) {
                                    elCuento = request.getParameter("campoCuentos");
                                    sesion.setAttribute("campoCuentos", elCuento);
                                } else {
                                    elCuento = (String) sesion.getAttribute("campoCuentos");
                                }

                                if ((sesion.getAttribute("tipoUsuario") != null) || !(elCuento.equalsIgnoreCase(""))) {

                                    String[] infoCuento = elCuento.split("-");
                                    String idCuento = infoCuento[0];
                                    String tituloCuento = infoCuento[1];
                                    String autorCuento = infoCuento[2];
                            %>

                            <%=tituloCuento%><br><br>
                            <%ArrayList<String> paginasCuento = AdminBD.darPaginasCuento(idCuento);
                                String contenido = "";
                                for (int i = 0; i < paginasCuento.size(); i++) {
                                    contenido = paginasCuento.get(i);
                            %>
                    ...
                    <%  
                        ...
                        String estadoConcurso = AdminBD.verificarEstadocuento(idCuento);

                        if ((tipoUsuario.equalsIgnoreCase("Lector")
                                || tipoUsuario.equalsIgnoreCase("Administrador")
                                || tipoUsuario.equalsIgnoreCase("Colaborador")) && estadoConcurso.equalsIgnoreCase("Abierto")) {
                    %>
                    ...
                    <div id="mid_content">
                        <div class="container">
                            <div class="mid_content_info mid_content_space">
                                <h2 id="">Calificar</h2>
                                <DIV ALIGN=center>
                                    <form action="calificar.jsp" method="POST" style="text-align: center;">
                                        <p style="text-align: center;">
                                            Puntos a otorgar (1-10):</p>
                                        <p style="text-align: center;">
                                            <input name="txtPuntos" type="text" /></p>
                                        <p style="text-align: center;">
                                            <input name="idCuen" type ="hidden" value ="<%=idCuento%>"/>
                                            <input name="autorCuen" type ="hidden" value ="<%=autorCuento%>"/>
                                            <input name="btnCalificar" type="submit" value="Calificar" /></p>
