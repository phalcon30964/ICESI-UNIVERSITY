                            ...
                            <form action="leerCuento.jsp" method="POST" style="text-align: center;">
                                <select name="campoCuentos" style="text-align: center;">
                                    ...
                                    <%                                        HttpSession sesion = request.getSession();
                                        ...
                                        String elConcurso = "";
                                        if (request.getParameter("campoAbiertos") != null) {
                                            elConcurso = request.getParameter("campoAbiertos");
                                            sesion.setAttribute("campoAbiertos", elConcurso);
                                        }else{
                                            elConcurso = (String) sesion.getAttribute("campoAbiertos");
                                        }
