                    ...
                    <div class="mid_content_info mid_content_space">
                        ...
                        <DIV ALIGN=center>
                            ...
                            <%
                                ...
                                String[] infoConcurso = concurso.split("-");
                                int idConcurso = Integer.parseInt(infoConcurso[0]);
                                ...
                                String diaCreacion = request.getParameter("diaCreacion");
                                String mesCreacion = request.getParameter("mesCreacion");
                                String anhoCreacion = request.getParameter("anhoCreacion");
                                String fechaCreacion = diaCreacion + "/" + mesCreacion + "/" + anhoCreacion;
                                String idCuento = AdminBD.creacionIDaleatorioCuento(clasificacion, fechaCreacion, titulo);
                                boolean creado = AdminBD.registrarCuento(idCuento, titulo, autor, clasificacion, fechaCreacion);
                                boolean registrado = AdminBD.registrarCuentoEnConcurso(idCuento, idConcurso);
                                boolean pagAgregada = AdminBD.registrarPagina("1", contenido, idCuento);
                                if (creado && registrado && pagAgregada) {%>

                            Cuento creado satisfactoriamente.

                            <%} else {%>
                            Problemas al crear el cuento. Intente nuevamente.
                            <%}%>
                        </DIV>
                    </div>
                    <div id="footer">
