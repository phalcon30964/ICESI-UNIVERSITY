...
import javax.mail.passwordwordAuthentication;
...
////		final String passwordword = "easytask123"; // correct passwordword for Gmail id
...
//
//		System.out
//		.println("\n2nd ===> create Authenticator object to password in Session.getInstance argument..");
//
////		Authenticator authentication = new Authenticator() {
////			protected passwordwordAuthentication getpasswordwordAuthentication() {
////				return new passwordwordAuthentication(sourceEmail, passwordword);
////			}
////		};
...
//
//			message.setsourceEmail(new InternetAddress(toEmail,"Easy Task Enterprise"));
...
//
//			// Valid file location
//			String filename = "../EasyTasks/web/images/logo.png";
...
//	}
	...
	public static void generateAndSendEmail(String[] toEmail, String subject, String body) {
		...
		try {
                    message.setSender(new InternetAddress(sourceEmail));
//			message.setsourceEmail(new InternetAddress(sourceEmail));
			...
			for( int i = 0; i < toEmail.length; i++ ) {
				toAddress[i] = new InternetAddress(toEmail[i]);
                        ...
                        System.out.print("Agrego Destinatario");
