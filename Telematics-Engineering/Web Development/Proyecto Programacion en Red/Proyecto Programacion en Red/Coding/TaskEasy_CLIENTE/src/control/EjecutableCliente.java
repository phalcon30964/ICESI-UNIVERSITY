...
public class EjecutableCliente {
	 ...
	 */
	public static void escucharReestablecerConstrasena(){
	 ...
	 * Pide al servidor darResumen de tareas por Semana Actual y con esa informacion actualiza la ventana tarea
	 */
	public static void escucharTareasPorSemanaActual(){
	...
	/**
	 * Estamos en la ventana resumen
	 * Pide al servidor darResumen de tareas por prioridad y con esa informacion actualiza la ventana tarea
	 */
	public static void escucharTareasPorPrioridad(){

	}
	
	/**
	 * Estamos en la ventana resumen
	 * Pide al servidor darResumen de tareas por Fecha Limite y con esa informacion actualiza la ventana tarea
	 */
	public static void escucharTareasPorFechaLimite(){

	}
	
	/**
	 * Estamos en la ventana resumen
	 * Pide al servidor darResumen de tareas por Nombre de forma alfabetica y con esa informacion actualiza la ventana tarea
	 */
	public static void escucharTareasPorNombre(){

	}
	
	/**
	 * Estamos en la ventana resumen
	 * Pide al servidor darResumen de tareas por Categoria y con esa informacion actualiza la ventana tarea
	 */
	public static void escucharTareasPorCategoria(){
	 ...
	 */
	public static void escucharAgregarCategoria(){
