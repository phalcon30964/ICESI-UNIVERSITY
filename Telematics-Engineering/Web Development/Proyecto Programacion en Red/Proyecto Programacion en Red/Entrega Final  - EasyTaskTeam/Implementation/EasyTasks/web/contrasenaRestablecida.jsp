...
<%
    String usuario = request.getParameter("elemento");
    ...
    if(usuario!=null){
        ...
        if(AdministradorBD.getConnection()){
            ...
            if(AdministradorBD.restablecerContrasena(usuario)){
                ...
                mensaje = "Tu contraseña se ha restablecido correctamente. Por favor revise su correo";
            }else{
                mensaje = "Error restableciendo su contraseña, por favor intente nuevamente";
...
<div id="main"> 
  ...
  <section id="top" class="one dark cover">
    <div class="container">
      <header>
        <h2 class="alt"><strong><%=mensaje%></strong></h2>
        <p>&nbsp;</p>
      </header>
