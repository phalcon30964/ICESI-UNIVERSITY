...
public class ColaPrioridad<T> implements IColaPrioridad<T>, Serializable{
	...
	public T getFront() {
		...
		//dikstra en todos los nodos no debe tener nigun 00
		//dikstra de a a b, y de a a b , alguno tiene 00 para cualquier par de vertices
		//encontrar 
	}
