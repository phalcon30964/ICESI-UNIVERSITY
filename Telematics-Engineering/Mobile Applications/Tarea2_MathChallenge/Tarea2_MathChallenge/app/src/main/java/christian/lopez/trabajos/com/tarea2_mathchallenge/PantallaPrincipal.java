 ...
 */
public class PantallaPrincipal extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public void crearJuego(View view){
        ...
        //Aqui extraigo algun elemento de la interfaz y tomo su valor a traves del finbdViewById
        EditText editText = (EditText) findViewById(R.id.editTextNombre);
        String nombreUsuario = editText.getText().toString();

        Juego juegoNuevo = new Juego(nombreUsuario);
        intent.putExtra(JUEGO,juegoNuevo);
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(PantallaPrincipal.this,
