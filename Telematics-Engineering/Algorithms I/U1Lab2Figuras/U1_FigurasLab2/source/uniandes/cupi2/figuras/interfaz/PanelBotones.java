...
public class PanelBotones extends JPanel implements ActionListener
{
    ...
    public PanelBotones( InterfazTriangulo elPadre )
    {
        ...
        etiquetaAltura = new JLabel( "Altura (ó Radio)" );
    ...
    public void cambiarInformacionC( double perimetro, double area, double altura )
    {
        etiquetaArea.setText( "Área: " + formatearValor( area ) + " px" );
        etiquetaPerimetro.setText( "Perímetro: " + formatearValor( perimetro ) + " px" );
        etiquetaAltura.setText( "Radio: " + formatearValor( altura ) + " px" );
    }
