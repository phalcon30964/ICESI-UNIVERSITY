...
public class PanelVentaBebidaUno extends JPanel implements ActionListener{
	...
	public PanelVentaBebidaUno(InterfazBebidas b){
		...
		TitledBorder titulo = new TitledBorder("Venta Naranja-Limon");
		setBorder(titulo);
		setLayout(new BorderLayout());
		
		//Inicializacion de los atributos
		
		ImageIcon imagen = new ImageIcon("img/bebidaUno.jpg");
		...
		txtPrecioUnidad = new JTextField("1000");
	...
	public void actionPerformed(ActionEvent event) {
		...
		if(evento.equals(VENDER_1_VASO)){
				...
				interfaz.gestionarVenta1VasoBebidaUno();
				
			}else if(evento.equals(VENDER_VARIOS)){
			
				interfaz.gestionarVentaVariosVasosBebidaUno();
