...
public class Taxi {
	...
	public double calcularGastosSemanales(){
	
		double gastosSemanales = 0;
		
		if(conductorUno!=null){
			gastosSemanales += conductorUno.calcularGastoSemanal();
		}
		
		if(conductorDos!=null){
			gastosSemanales += conductorDos.calcularGastoSemanal();
		}
